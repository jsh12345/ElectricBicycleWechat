...
public class SoDetail {
	...
	public double getRetu_qty() {
		return retu_qty;
	}
	public void setRetu_qty(double retu_qty) {
		this.retu_qty = retu_qty;
	}
	...
	public double getNotax_amt() {
		return notax_amt;
	}
	public void setNotax_amt(double notax_amt) {
		this.notax_amt = notax_amt;
	}
